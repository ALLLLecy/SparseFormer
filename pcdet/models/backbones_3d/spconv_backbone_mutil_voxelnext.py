...
class VoxelResBackBone8_32xVoxelNeXt(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        x_conv4_out = self.conv_out_x4(self.bev_out(x_conv4))
        x_conv5_out = self.conv_out_x5(self.bev_out(x_conv5))
        x_conv6_out = self.conv_out_x6(self.bev_out(x_conv6))

        batch_dict.update({
            'encoded_spconv_tensor': [x_conv4_out, x_conv5_out, x_conv6_out],
            'encoded_spconv_tensor_stride': [8, 16, 32]
        })
        batch_dict.update({
